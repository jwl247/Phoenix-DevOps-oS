...
- Fixed: /etc/phoenix-cifs.creds created (username=jwlef, password=***REMOVED-CREDENTIAL-ROTATED-2026-09-25***, domain=)
...
1. **Fix cloud-init seed** — `tools/poc/debian-seed/user-data` needs:
   ...
   - Write `/etc/phoenix-cifs.creds` (username=jwlef, password=***REMOVED-CREDENTIAL-ROTATED-2026-09-25***)
