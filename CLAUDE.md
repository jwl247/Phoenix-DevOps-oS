...
## NEXT SESSION
- **Deploy Life First** — boot the Debian VM, run `sector2/apps/lifefirst/install.sh`, verify end to end, `cloudflared tunnel login` + create the tunnel, hand Laurie the link.
- **Life First MCP auth** — `/mcp` → claude.ai Life First App (Jerry's side, OAuth).
