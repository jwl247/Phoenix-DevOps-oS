...
- **Office Phase 2, Modules 3-6** — real notification transport (Cloudflare Email Workers), LibreOffice/Frank/Helix wiring (`phoenix-unoserver.service` exists, dormant, nothing calls it yet), Google/Windows pluggable sign-in, the dual-pane UI itself. Full plan in the session-close approval; Modules 1-2 are done.
