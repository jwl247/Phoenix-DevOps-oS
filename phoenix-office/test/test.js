// Phoenix Office (standalone) — core engine tests. Cloned unchanged from
// sector2/apps/office/test/test.js (2026-09-22) — same libs, byte-identical,
// so the same 53 assertions apply here with zero modification.
