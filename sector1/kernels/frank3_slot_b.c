...
// frank3_slot_b.c — Frank3 Kernel Slot B
// Phoenix DevOps LLC — jwl247
// Builds as frank3_slot_b.ko and sideloads into helix.ko: insmod helix.ko first,
...
MODULE_DESCRIPTION("Frank3 Slot B — Phoenix kernel sideload into Helix");
MODULE_VERSION("2.0");

static const int slot_id = 2;
...
static void slot_tick(struct helix_slot *slot, const struct helix_stats *st)
{
	...
	if (band != last_band) {
		helix_intent_post("frank3_slot_b pressure_band=%d pct=%u",
