@echo off
REM ============================================================
REM Phoenix Global Command: clone
REM Windows CMD wrapper for Phoenix Clone (Sector 2 intake)
REM ============================================================
...
if not defined PHOENIX_ROOT (
    if exist "%USERPROFILE%\Phoenix\Phoenix-DevOps-oS\tools\clone.ps1" (
