...
# XAI_API_KEY=xai-...   # Grok Help Desk fallback when Ollama is down
...
if ($ollama) {
    ...
    Write-Host "  [WARN] Ollama not in PATH — Help Desk will use Grok/Claude fallback until installed" -ForegroundColor Yellow
