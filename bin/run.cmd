@echo off
REM ============================================================
REM Phoenix Global Command: run
REM Windows CMD wrapper for Suite Execution
REM ============================================================
...
REM Execute run command via usys
...
"%PWSH_EXE%" -NoProfile -ExecutionPolicy Bypass -File "%PHOENIX_ROOT%\scripts\usys.ps1" run %*
